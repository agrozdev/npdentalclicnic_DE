...
<h2>Quality is the real story</h2>
<p>Patients sometimes assume cheaper means lower quality. In reality, well-run Bulgarian clinics use exactly the same materials as their UK counterparts — the difference is in the cost of running a clinic, not the cost of an implant.</p>

<blockquote>“We use Straumann and Nobel Biocare implants, the same brands a London prosthodontist would use. The implant doesn’t care which country it is placed in — what matters is the surgeon, the planning and the sterilisation.”</blockquote>

<h2>What a typical trip looks like</h2>
<p>For most UK patients, treatment fits into two short visits.</p>
<ul>
    <li><strong>Visit 1 (2–4 days)</strong>: examination, 3D scan, surgery or aligner fitting, and a recovery day before flying home.</li>
    <li><strong>At home</strong>: healing period with WhatsApp or email support from the clinic.</li>
    <li><strong>Visit 2 (2–3 days)</strong>: final fitting of crowns, bridges or aligner refinements.</li>
</ul>

<h2>Things to check before you book</h2>
<ul>
    <li>Is the clinic transparent about the implant brand, and will they give you the implant passport on departure?</li>
    <li>Do they provide a written treatment plan and quote in English <em>before</em> you fly?</li>
    <li>Is the surgeon a specialist with documented experience in your specific procedure?</li>
