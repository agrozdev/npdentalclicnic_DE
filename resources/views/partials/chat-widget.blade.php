...
<div id="np-chat-widget">
    ...
    <div id="np-chat-window" role="dialog" aria-label="NP Dental Chat" hidden>
        ...
        <div id="np-chat-step" hidden>
            ...
            <div id="np-whatsapp-banner" hidden>
                <a href="https://wa.me/359878106603" target="_blank" rel="noopener">
                    ...
                    Continue on WhatsApp for detailed help
                </a>
            </div>
...
#np-whatsapp-banner { margin: 0 12px 8px; border-radius: 10px; background: #25d366; overflow: hidden; }
#np-whatsapp-banner[hidden] { display: none; }
#np-whatsapp-banner a {
    display: flex; align-items: center; gap: 8px;
    padding: 10px 14px; color: #fff; text-decoration: none;
    font-size: 13px; font-weight: 500;
}
#np-whatsapp-banner svg { width: 20px; height: 20px; flex-shrink: 0; }
...
(function () {
    ...
    const waBanner    = document.getElementById('np-whatsapp-banner');
